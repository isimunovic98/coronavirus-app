// MARK: - Mocks generated from file: CoronaVirusApp/Modules/LatestNews/Repository/LatestNewsRepository.swift at 2021-05-07 20:36:39 +0000
...
import Foundation
 ...
 class MockLatestNewsRepository: LatestNewsRepository, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("getLatestNews(withOffset: Int) -> AnyPublisher<Result<LatestNewsResponseItem, ErrorType>, Never>",
            parameters: (offset),
	 ...
	 struct __StubbingProxy_LatestNewsRepository: Cuckoo.StubbingProxy {
	    ...
	    func getLatestNews<M1: Cuckoo.Matchable>(withOffset offset: M1) -> Cuckoo.ProtocolStubFunction<(Int), AnyPublisher<Result<LatestNewsResponseItem, ErrorType>, Never>> where M1.MatchedType == Int {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockLatestNewsRepository.self, method: "getLatestNews(withOffset: Int) -> AnyPublisher<Result<LatestNewsResponseItem, ErrorType>, Never>", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_LatestNewsRepository: Cuckoo.VerificationProxy {
	    ...
	    func getLatestNews<M1: Cuckoo.Matchable>(withOffset offset: M1) -> Cuckoo.__DoNotUse<(Int), AnyPublisher<Result<LatestNewsResponseItem, ErrorType>, Never>> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: offset) { $0 }]
	        return cuckoo_manager.verify("getLatestNews(withOffset: Int) -> AnyPublisher<Result<LatestNewsResponseItem, ErrorType>, Never>", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
    ...
    return cuckoo_manager.call("getLatestNews(withOffset: Int) -> AnyPublisher<Result<LatestNewsResponseItem, ErrorType>, Never>",
	 ...
	 struct __StubbingProxy_LatestNewsRepositoryImpl: Cuckoo.StubbingProxy {
	    ...
	    func getLatestNews<M1: Cuckoo.Matchable>(withOffset offset: M1) -> Cuckoo.ClassStubFunction<(Int), AnyPublisher<Result<LatestNewsResponseItem, ErrorType>, Never>> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: offset) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockLatestNewsRepositoryImpl.self, method: "getLatestNews(withOffset: Int) -> AnyPublisher<Result<LatestNewsResponseItem, ErrorType>, Never>", parameterMatchers: matchers))
	    }
